...
public class UsuarioTest {
    ...
    public void crearUsuario() throws Exception {
        ...
        UserModel usuario = new UserModel("juan.gutierrez@gmail.com");
    ...
    public void comprobarIgualdadUsuariosSinId() {
        ...
        UserModel usuario1 = new UserModel("juan.gutierrez@gmail.com");
        UserModel usuario2 = new UserModel("juan.gutierrez@gmail.com");
        UserModel usuario3 = new UserModel("ana.gutierrez@gmail.com");
    ...
    public void comprobarIgualdadUsuariosConId() {
        ...
        UserModel usuario1 = new UserModel("juan.gutierrez@gmail.com");
        UserModel usuario2 = new UserModel("pedro.gutierrez@gmail.com");
        UserModel usuario3 = new UserModel("ana.gutierrez@gmail.com");
    ...
    public void crearUsuarioBaseDatos() throws ParseException {
        ...
        UserModel usuarioBD = usuarioRepository.findById(usuario.getId()).orElse(null);
    ...
    public void buscarUsuarioEnBaseDatos() {
        ...
        UserModel usuarioBD = usuarioRepository.findById(usuarioId).orElse(null);
    ...
    public void buscarUsuarioPorEmail() {
        ...
        UserModel usuarioBD = usuarioRepository.findByEmail("user@ua").orElse(null);
